...
class BaseConsumer(object):
    ...
    def reconnect(self, delay=5):
        ...
        if self._closing:
            ...
            self._connection.add_timeout(delay, self.connect)
    ...
    def on_message(self, unused_channel, basic_deliver, properties, body):
        ...
        self._connection.ioloop.spawn_callback(self.process_message_on_exception, basic_deliver.delivery_tag, properties.app_id, body)
