...
class TaskModel():
    ...
    async def rpop(self, semaphore, site, type):
        async with semaphore:
            await self.redis_client.rpop('{}_{}'.format(site, type))
...
if __name__ == '__main__':
    ...
    task = [asyncio.ensure_future(t(semaphore, site ,type=1)) for i in range(1000)]
    start = time.time()
