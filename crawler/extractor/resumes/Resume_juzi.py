...
class HtmlToDict(BaseExtract, Base):
    ...
    def resume_info(self):
        ...
        self.registered_capital = ""  # "163.2026 万人民币"  todo
        self.registered_owner = ""  # "何斌",  todo
        self.registered_phone= ""  # "13269781234"  todo
        self.develops = []
        develop = {}
        ...
        #              "prencent":"比例70%"
        #              "type":"出资方式"
        #              "create_time": 140101111，
        #              "update_time": 140101111，},]
        # }
        for ele in shareholders_ele:  # todo
            shareholders = {}  # 置空
            shareholders["name"] = ele.get("name", "")
            shareholders["money"] = ele.get("position", "")
            shareholders["prencent"] = ("https://www.lagou.com/" + ele.get("photo", "")) if ele.get("photo", "") else ""
            shareholders["type"] = self.reset_style(ele.get("remark", ""))  # boss暂无标签
